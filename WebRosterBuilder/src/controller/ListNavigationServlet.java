	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act == null) {
			...
			try {
				...
				request.setAttribute("coachName", listToEdit.getCoachName());
				PlayerHelper daoForItems = new PlayerHelper();
				
				request.setAttribute("allItems", daoForItems.showAllPlayers());
				
				if(daoForItems.showAllPlayers().isEmpty()) {
